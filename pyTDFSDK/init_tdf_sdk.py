...
def init_tdf_sdk_api(bruker_api_file_name=""):
    ...
    if bruker_api_file_name == "":
        if platform.system() == "Windows":
            bruker_api_file_name = os.path.join(
                os.path.split(os.path.dirname(__file__))[0], "TDF-SDK", "timsdata.dll"
            )
    ...
    tdf_sdk.tims_ccs_to_oneoverk0_for_mz.argtypes = [c_double, c_int32, c_double]
    tdf_sdk.tims_ccs_to_oneoverk0_for_mz.restype = c_double

    tdf_sdk.tims_close.argtypes = [c_uint64]
    tdf_sdk.tims_close.restype = None

    tdf_sdk.tims_extract_centroided_spectrum_for_frame_ext.argtypes = [
        c_uint64,
        c_int64,
        c_uint32,
        c_uint32,
    ...
    tdf_sdk.tims_extract_centroided_spectrum_for_frame_v2.argtypes = [
        c_uint64,
        c_int64,
        c_uint32,
        c_uint32,
    ...
    tdf_sdk.tims_extract_chromatograms.argtypes = [
        c_uint64,
    ...
    tdf_sdk.tims_extract_profile_for_frame.argtypes = [
        c_uint64,
        c_int64,
        c_uint32,
        c_uint32,
    ...
    tdf_sdk.tims_get_last_error_string.argtypes = [c_char_p, c_uint32]
    ...
    tdf_sdk.tims_oneoverk0_to_ccs_for_mz.argtypes = [c_double, c_int32, c_double]
    ...
    tdf_sdk.tims_open.argtypes = [c_char_p, c_uint32]
    tdf_sdk.tims_open.restype = c_uint64

    tdf_sdk.tims_open_v2.argtypes = [c_char_p, c_uint32, c_uint32]
    tdf_sdk.tims_open_v2.restype = c_uint64

    tdf_sdk.tims_read_pasef_msms.argtypes = [
        c_uint64,
        POINTER(c_int64),
        c_uint32,
        MSMS_SPECTRUM_FUNCTOR,
    ...
    tdf_sdk.tims_read_pasef_msms_for_frame.argtypes = [
        c_uint64,
        c_int64,
        MSMS_SPECTRUM_FUNCTOR,
    ]
    ...
    tdf_sdk.tims_read_pasef_msms_for_frame_v2.argtypes = [
        c_uint64,
        c_int64,
    ...
    tdf_sdk.tims_read_pasef_msms_v2.argtypes = [
        c_uint64,
        POINTER(c_int64),
        c_uint32,
        MSMS_SPECTRUM_FUNCTION,
    ...
    tdf_sdk.tims_read_pasef_profile_msms.argtypes = [
        c_uint64,
        POINTER(c_int64),
        c_uint32,
        MSMS_PROFILE_SPECTRUM_FUNCTOR,
    ...
    tdf_sdk.tims_read_pasef_profile_msms_for_frame.argtypes = [
        c_uint64,
        c_int64,
        MSMS_PROFILE_SPECTRUM_FUNCTOR,
    ]
    ...
    tdf_sdk.tims_read_pasef_profile_msms_for_frame_v2.argtypes = [
        c_uint64,
        c_int64,
    ...
    tdf_sdk.tims_read_pasef_profile_msms_v2.argtypes = [
        c_uint64,
        POINTER(c_int64),
        c_uint32,
        MSMS_PROFILE_SPECTRUM_FUNCTION,
    ...
    tdf_sdk.tims_read_scans_v2.argtypes = [
        c_uint64,
        c_int64,
        c_uint32,
        c_uint32,
    ...
    tdf_sdk.tims_vis_calculate_async.argtypes = [
        c_uint64,
    ...
    tdf_sdk.tims_vis_get_chromatogram_line_plot.argtypes = [
        c_uint64,
        c_int32,
        c_int32,
        c_uint32,
    ...
    tdf_sdk.tims_vis_get_image_mob_mz.argtypes = [
        c_uint64,
        c_uint32,
        POINTER(c_float),
        c_uint32,
    ...
    tdf_sdk.tims_vis_get_image_rt_mob.argtypes = [
        c_uint64,
        c_uint32,
        POINTER(c_float),
        c_uint32,
    ...
    tdf_sdk.tims_vis_get_image_rt_mz.argtypes = [
        c_uint64,
        c_uint32,
        POINTER(c_float),
        c_uint32,
    ...
    tdf_sdk.tims_vis_get_last_error_string.argtypes = [c_char_p, c_uint32]
    tdf_sdk.tims_vis_get_last_error_string.restype = c_uint32

    tdf_sdk.tims_vis_get_mobilogram_line_plot.argtypes = [
        c_uint64,
        c_int32,
        c_int32,
        c_uint32,
    ...
    tdf_sdk.tims_vis_get_spectrum_line_plot.argtypes = [
        c_uint64,
        c_int32,
        c_int32,
        c_uint32,
    ...
    tdf_sdk.tims_vis_get_state.argtypes = [c_uint64, c_uint64, c_float, c_bool]
    tdf_sdk.tims_vis_get_state_restype = c_uint32

    tdf_sdk.tims_vis_open.argtypes = [c_char_p, c_uint32]
    tdf_sdk.tims_vis_open.restype = c_uint64

    tdf_sdk.tims_vis_wait.argtypes = [c_uint64, c_uint32]
    ...
    tdf_sdk.tsf_get_last_error_string.argtypes = [c_char_p, c_uint32]
    ...
    tdf_sdk.tsf_open.argtypes = [c_char_p, c_uint32]
    tdf_sdk.tsf_open.restype = c_uint64

    tdf_sdk.tsf_read_line_spectrum.argtypes = [
        c_uint64,
        c_int64,
        POINTER(c_double),
        POINTER(c_float),
    ...
    tdf_sdk.tsf_read_line_spectrum_v2.argtypes = [
        c_uint64,
        c_int64,
        POINTER(c_double),
        POINTER(c_float),
    ...
    tdf_sdk.tsf_read_line_spectrum_with_width_v2.argtypes = [
        c_uint64,
        c_int64,
        POINTER(c_double),
        POINTER(c_float),
    ...
    tdf_sdk.tsf_read_profile_spectrum.argtypes = [
        c_uint64,
        c_int64,
        POINTER(c_uint32),
        c_uint32,
    ...
    tdf_sdk.tsf_read_profile_spectrum_v2.argtypes = [
        c_uint64,
        c_int64,
        POINTER(c_uint32),
        c_int32,
